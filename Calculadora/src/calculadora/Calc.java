...
public class Calc extends javax.swing.JFrame {
    String Memory1,Signo,Memory2,Memory3="0";
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(20, 20, 20)
                        .addComponent(TxtPantalla, javax.swing.GroupLayout.PREFERRED_SIZE, 337, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(36, 36, 36)
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
       String Resultado;
       Memory2=TxtPantalla.getText();
       
       if(!Memory2.equals(""))
       {
       Resultado=ObtenerResultado(Memory1,Memory2,Signo);
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        String cadena;
        cadena=TxtPantalla.getText();
         TxtPantalla.setText(Memory3);
        if(cadena.length()>0)
        {
        numero=Double.parseDouble(Memory3)+Double.parseDouble(cadena);
        Memory3=String.valueOf(numero);
        TxtPantalla.setText(String.valueOf(numero));
        }
    ...
    public static String ObtenerResultado(String Memory1, String Memory2, String Signo) 
    {
       Double resultado=0.0;
       
       if(Signo.equals("-"))
       {
           resultado=Double.parseDouble(Memory1)-Double.parseDouble(Memory2);
       }
        if(Signo.equals("+"))
       {
           resultado=Double.parseDouble(Memory1)+Double.parseDouble(Memory2);
          ...
          if(Signo.equals("/"))
       {
           resultado=Double.parseDouble(Memory1)/Double.parseDouble(Memory2);
             ...
             if(Signo.equals("^"))
       {
           resultado=Math.pow(Double.parseDouble(Memory1),Double.parseDouble(Memory2) );
       }
